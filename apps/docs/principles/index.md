...
```mermaid
flowchart TD
    D[1. Desire] --> F[2. Faith]
    F --> AS[3. Auto-Suggestion]
    AS --> SK[4. Specialized Knowledge]
    SK --> I[5. Imagination]
    I --> OP[6. Organized Planning]
    OP --> Dec[7. Decision]
    Dec --> P[8. Persistence]
    P --> MM[9. Master Mind]
    MM --> ST[10. Sex Transmutation]
    ST --> SC[11. Subconscious Mind]
    SC --> B[12. The Brain]
    B --> SS[13. The Sixth Sense]

    style D fill:#f59e0b,color:#000
    style SS fill:#f5c518,color:#000
```
